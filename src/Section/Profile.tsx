...
const Profile: React.FC = () => {
  return (
    <section className="flex flex-col md:flex-row items-center justify-between bg-black min-h-screen p-4 md:p-8 relative mb-40">
      ...
      <h1 className="block md:hidden text-center italic text-sm md:text-[2.5rem] md:absolute md:top-16 md:right-[10%] text-zinc-400 font-base mt-2 mb-0">
        Youtube: Desa Wisata Genggelang
      </h1> 

      {/* Text Content */}
      <div className="relative z-50 md:absolute md:left-[10%] top-5 backdrop-blur-md bg-[#141414] p-4 md:p-8 text-white/80 rounded-xl shadow-lg max-w-md md:max-w-lg md:mr-8 mb-8 md:mb-0 border border-white/30">
