...
const Geografis: React.FC = () => {
  return (
    <section className="flex flex-col md:flex-row items-center justify-between  min-h-screen mx-8 relative">
      ...
      <div className="md:absolute 2xl:top-24 2xl:right-[5%] md:top-24 md:left-[25%] w-full md:w-auto text-center md:text-center 2xl:text-right mb-6 md:mb-0">
      ...
      <div className="relative z-0 w-full 2xl:w-1/2 max-w-4xl mb-4 md:mb-0 md:absolute 2xl:absolute md:left-[10%] md:top-[20%] 2xl:left-[10%] 2xl:top-[15%]">
        <img
          src={letakGeografis}
