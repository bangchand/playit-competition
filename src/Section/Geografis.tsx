...
const Geografis: React.FC = () => {
  return (
    <section className="flex flex-col md:flex-row items-center justify-between  min-h-screen mx-8 relative">
      ...
      <div className="relative z-0 w-full md:w-1/2 max-w-4xl mb-4 md:mb-0 md:absolute md:left-[10%] md:top-[15%]">
        <img
          src={letakGeografis}
      ...
      <h1 className="absolute top-[13%] left-[10%] md:left-[5%] md:top-[66%] text-white/70 transition-all duration-300 hover:text-white italic pl-3 pt-2 text-[10px] md:text-sm mb-4">
